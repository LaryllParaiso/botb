...
if (empty($name) || empty($round_id) || empty($performance_order)) {
...
try {
    ...
    echo json_encode(['success' => true, 'message' => 'Band created successfully.']);
} catch (Exception $e) {
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Failed to create band.']);
}
